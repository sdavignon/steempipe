      ...
      >
        <div className="LoginModal__body">
          ...
          <span className="LoginModal__login-title">
            <FormattedMessage id="login_to_busy" defaultMessage="Login to STEEMPipe" />
          </span>
          <span className="LoginModal__login-description">
            <FormattedMessage
              id="login_modal_description"
              defaultMessage="Login with your Steem account using SteemConnect to enjoy STEEMPipe at 100%"
            />
          </span>
